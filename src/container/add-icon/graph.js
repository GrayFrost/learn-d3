...
class Graph {
    ...
    constructor(selector, data, options) {
        ...
        this.gEdgeLayer = this.gZoomLayer
            .append("g")
            .attr("class", "gEdgeLayer");

        this.gEdgeTextLayer = this.gZoomLayer
            .append("g")
            .attr("class", "gEdgeTextLayer");

        // 管理节点的容器g
        this.gCircleLayer = this.gZoomLayer
            .append("g")
            .attr("class", "gCircleLayer");

        this.gImageLayer = this.gZoomLayer
            .append("g")
            .attr("class", "gImageLayer");
    ...
    drawCircleNode() {
        ...
        gCircle = gCircle.enter().append("g").attr("class", "circleWrap");
