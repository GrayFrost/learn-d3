...
class Graph {
    ...
    constructor(selector, data, options) {
        ...
        eventEmitter.on("active-node", (data) => {
            console.log("zzh receive data", data);
            ...
            nodeImage.style("opacity", (o) => {
                return this.isConnected(data, o) ? 1: 0.3;
            });

            edgeLine.style("stroke-opacity", (o) => {
                return o.source === data || o.target === data ? 1: 0.3;
            });
        });
    }
    ...
    addHover() {
        ...
        nodeImage
            .on("mouseover", (d) => {
                nodeImage.style("opacity", (o) => {
                    return this.isConnected(d, o) ? 1: 0.3;
                });
